  ...
  return (
    ...
    >
      <View style={styles.board}>
        <Text style={[styles.boardTitle, { color: colors.text }]}>To Do</Text>
      ...
      >
        <Text
          style={[styles.fabText, theme === "dark" && { color: "#FFFFFF" }]}
        >
          +
        </Text>
      </Pressable>
...
const DraggableTodo = ({
  ...
  }, [todo.x, todo.y, todo.rotation, offset, start, rotation, startRotation]);
  ...
  const pan = React.useMemo(
    ...
    [todo, onUpdate, isPressed, offset, start, rotation],
  );
  ...
  const rotate = React.useMemo(
    ...
    [todo, onUpdate, isPressed, rotation, startRotation, offset],
  );
  ...
  const longPress = React.useMemo(
    () =>
      Gesture.LongPress().onEnd((_e, success) => {
        if (success) {
  ...
  const gesture = React.useMemo(
    () => Gesture.Simultaneous(rotate, Gesture.Exclusive(longPress, tap, pan)),
